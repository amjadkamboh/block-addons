...
registerBlockType( 'wpm-captain-block/explanatory-block-list', {
	...
	edit: (props) => { 
		...
		const { heroTitle, heroDes, heroCta, heroLink,} = attributes;
