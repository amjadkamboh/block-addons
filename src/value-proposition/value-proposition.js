...
registerBlockType( 'wpm-captain-block/proposition-block-list', {
	title: __( 'Value Proposition' ), // Block title.
	...
	save : (props) => { 
		...
		const { headingTitle, maintDes, heroCta, heroLink, RichTextTitle, TextDes, RichTextTitle1, TextDes1, RichTextTitle2, TextDes2} = attributes;
